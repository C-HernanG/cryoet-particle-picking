...
Usage:
    ...
    python ../../experiments/exp4_ppicker_rotations/scripts/umusynth_inference_large.py --checkpoint-type base
    python ../../experiments/exp4_ppicker_rotations/scripts/umusynth_inference_large.py --checkpoint-type single --increment 8
    python ../../experiments/exp4_ppicker_rotations/scripts/umusynth_inference_large.py --checkpoint-type multi --increment 8
    
    # Run inference with a specific prompt:
    python ../../experiments/exp4_ppicker_rotations/scripts/umusynth_inference_large.py --prompt-idx 0
"""
...
if __name__ == "__main__":
    ...
    if args.checkpoint_type not in (None, FIXED_CHECKPOINT_TYPE):
        print(
            f"⚠️ Ignoring --checkpoint-type {args.checkpoint_type}. "
            f"Using fixed {FIXED_CHECKPOINT_TYPE}."
        )
    if args.increment not in (None, FIXED_INCREMENT):
        print(
            f"⚠️ Ignoring --increment {args.increment}. "
