...
Usage:
    ...
    python ../../experiments/exp4_ppicker_rotations/scripts/polnet_inference.py
    
    # Run inference for a specific checkpoint type:
    python ../../experiments/exp4_ppicker_rotations/scripts/polnet_inference.py --checkpoint-type base
    python ../../experiments/exp4_ppicker_rotations/scripts/polnet_inference.py --checkpoint-type single --increment 8
    python ../../experiments/exp4_ppicker_rotations/scripts/polnet_inference.py --checkpoint-type multi --increment 8
    
    # Run inference with a specific prompt:
    python ../../experiments/exp4_ppicker_rotations/scripts/polnet_inference.py --prompt-idx 0
"""
